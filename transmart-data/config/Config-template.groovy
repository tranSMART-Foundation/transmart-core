...
else if (Environment.is(Environment.PRODUCTION)) {
    com.rwg.solr.scheme = 'http'
    com.rwg.solr.host   = 'localhost:' + solrPort
    com.rwg.solr.path   = '/solr/rwg/select/'
}
...
environments { development {
    com.recomdata.sessionTimeout = 300 // Integer.MAX_VALUE / 1000 as int /* ~24 days */
    com.recomdata.heartbeatLaps = 30 // 900
} }
...
grails { plugin { springsecurity {
    ...
    if (oauthEnabled) {
        ...
        // NOTE structure of chainMap changed
